...
def compute_coherence(
    ...
    K = coefficientSpectrum.shape[1]

    ck = coefficientSpectrum[:,k]


    norm_k = np.linalg.norm(ck)
...
def orvmd(
    ...
    while (
        ...
        for k in range(K):
            ...
            receiveCont, sendCont = compute_transfer(
